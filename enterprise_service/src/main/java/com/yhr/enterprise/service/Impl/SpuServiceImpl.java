...
import com.yhr.enterprise.dao.CategoryBrandMapper;
import com.yhr.enterprise.dao.CategoryMapper;
import com.yhr.enterprise.dao.SkuMapper;
import com.yhr.enterprise.dao.SpuMapper;
import com.yhr.enterprise.entity.PageResult;
import com.yhr.enterprise.pojo.*;
import com.yhr.enterprise.service.SpuService;
import com.yhr.enterprise.util.IdWorker;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void add(Spu spu ,String specname) {
        ...
        System.out.println(spu.getSpecItems());
        //保存sku列表的信息
        List<Sku> skuList =new ArrayList<>();
        Map map= JSON.parseObject(spu.getSpecItems());
        System.out.println(map);
        JSONArray array= (JSONArray) map.get(specname);
        System.out.println(specname);
        System.out.println(array);
        Object[] strs =array.toArray();
        System.out.println(strs);

        for (Object str:strs) {
            Sku sku =new Sku();
            String temp ="{\""+specname+"\":\""+str.toString()+"\"}";
            sku.setSpec(temp);
            skuList.add(sku);
        }
        //创建保存和更新的时间
    ...
    public Goods findGoodsById(String id) {
        ...
        System.out.println(spu.getCaption());
        //查询sku列表
        Example example=new Example(Sku.class);
        Example.Criteria criteria=example.createCriteria();
    ...
    public void audit(String id, String status, String message) {
        ...
        rabbitTemplate.convertAndSend("enterprise.goodput","",spuID);
        //记录商品审核记录  待完成
    ...
    public void pull(String id) {
        ...
        spuMapper.updateByPrimaryKeySelective(spu);
        String spuID = spu.getId();
        rabbitTemplate.convertAndSend("enterprise.goodpull","",spuID);
        //记录商品日志    待完成
    }
